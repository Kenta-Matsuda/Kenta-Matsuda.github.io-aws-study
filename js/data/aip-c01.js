              ...
              items: [
                {
                  ...
                  note: 'エージェンティック AI の構築とツール統合（AWS の現行のエージェント基盤）',
                  noteEn: 'Building agentic AI and tool integration (AWS current agent platform)',
                  recommend: true,
                },
                {
            ...
            },
            {
              ...
              items: [
                ...
                },
                {
                  ...
                  note: 'ビジネスシステムとの GenAI 統合。AWS は Amazon Q Business の後継として本サービスを案内している',
                  noteEn: 'GenAI integration with business systems. AWS points to this service as the successor to Amazon Q Business',
                },
              ],
            },
          ],
