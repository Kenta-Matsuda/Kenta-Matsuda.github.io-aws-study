            ...
            },
            {
              ...
              items: [
                ...
                },
                {
                  ...
                  note: '監査エビデンスの収集・管理。本サービスは新規顧客の受付を終了しているが、SCS-C03 の試験ガイドではスコープ内サービスとして明記されているため掲載を継続する',
                  noteEn: 'Audit evidence collection and management. The service is no longer open to new customers, but it remains listed here because the SCS-C03 exam guide still names it as an in-scope service',
                },
              ],
            },
          ],
