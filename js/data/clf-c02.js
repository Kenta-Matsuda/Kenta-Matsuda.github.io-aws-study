            ...
            },
            {
              ...
              items: [
                ...
                },
                {
                  ...
                  note: '移行の進捗を追跡する一元管理サービス（プロダクトページは AWS Transform へ転送されるため、サービスの説明は公式ドキュメントを参照）',
                  noteEn: 'Centralized service for tracking migration progress (the product page now redirects to AWS Transform, so refer to the official documentation for the service itself)',
                },
              ],
            },
          ],
