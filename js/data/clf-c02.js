          ...
          resources: [
            ...
            },
            {
              ...
              items: [
                ...
                {
                  title: 'AWS Snowball',
                  titleEn: 'AWS Snowball',
                  url: 'https://aws.amazon.com/jp/snowball/',
                  urlEn: 'https://aws.amazon.com/snowball/',
                ...
                },
                {
                  ...
                  note: '移行の進捗を追跡する一元管理サービス。本サービスは 2025-11-07 付で新規顧客の受付を終了しており、AWS は後継として AWS Transform を案内しているが、CLF-C02 の試験ガイドではスコープ内サービスとして明記されているため掲載を継続する',
                  noteEn: 'Centralized service for tracking migration progress. The service is no longer open to new customers as of 2025-11-07 and AWS points to AWS Transform as the successor, but it remains listed here because the CLF-C02 exam guide still names it as an in-scope service',
                },
              ],
            },
          ],
              ...
              items: [
                {
                  ...
                  url: 'https://aws.amazon.com/jp/ai/machine-learning/',
                  urlEn: 'https://aws.amazon.com/ai/machine-learning/',
                  note: 'AI/ML サービスの全体像',
              ...
              items: [
                {
                  ...
                  url: 'https://docs.aws.amazon.com/ja_jp/account-billing/',
                  urlEn: 'https://docs.aws.amazon.com/account-billing/',
                  note: '請求・コスト管理の基礎',
          ...
          resources: [
            {
              ...
              items: [
                ...
                },
                {
                  ...
                  url: 'https://aws.amazon.com/jp/premiumsupport/technology/aws-health/',
                  urlEn: 'https://aws.amazon.com/premiumsupport/technology/aws-health/',
